...
void first(){
    	...
    	glColor3f(0.0, 0.0, 0.0);
    	strokeString(450, 1400, 0.5, 0.5, "PES INSTITUTE OF TECHNOLOGY", 5);
	...
	glColor3f(0.5, 0, 0.1);
    	strokeString(70, 550, 0.5, 0.5, "Press (SPC+ENTER) to continue", 4);
    	strokeString(1250, 530, 0.35, 0.35, "By:", 3);
   
    	glColor3f(0,0,0);
    	strokeString(1250, 450, 0.35, 0.35, "AMRUTHA S R, ANANYA R", 3);
    	strokeString(1250, 380, 0.35, 0.35, "1PE15CS019, 1PE15CS020", 3);
	
	glColor3f(0.5, 0, 0.1);
	strokeString(1200, 220, 0.35, 0.35, "Under the guidance of:", 3);    	
	
    	glColor3f(0,0,0);	
	strokeString(1210, 150, 0.4, 0.4, "Prof.Ms.Sudeepa Roy Dey",3);
	strokeString(1180,80,0.4,0.4," Prof.Ms.Neeta Ann Jacob", 3);
